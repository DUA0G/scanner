...
def ping_call(ipaddr, success_ips):
    fnull = open(os.devnull, 'w')
    result = subprocess.call('ping ' + str(ipaddr) + ' -n 2', shell=True, stdout=fnull, stderr=fnull)
    current_time = time.strftime('%Y%m%d-%H:%M:%S', time.localtime())
    if result:
        print('时间:{} ip地址:{} ping fall'.format(current_time, ipaddr))
    else:
        print('时间:{} ip地址:{} ping ok'.format(current_time, ipaddr))
        success_ips.append(ipaddr)  # 添加成功的IP到列表中
    fnull.close()
...
def asynchronous():  # 异步
    networks = ['211.22.90.0/24','198.175.7.0/24','64.154.25.0/24','43.135.46.0/24','35.206.251.0/24','185.241.5.0/24','165.22.92.0/24','113.30.150.0/24','206.189.61.0/24','24.199.98.0/24','164.92.167.0/24','170.64.148.0/24','165.22.22.0/24','104.248.48.0/24','165.22.17.0/24','170.64.158.0/24','113.30.191.0/24','113.30.151.0/24','45.83.43.0/24','185.139.228.0/24','103.252.118.0/24','185.229.226.0/24','103.252.119.0/24','159.65.5.0/24']
    ip_list = []
